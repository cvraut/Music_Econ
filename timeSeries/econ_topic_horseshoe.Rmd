...
=======
```{r}
econ_emotion <- function(overall_lag, econ_features, target_name) 
>>>>>>> 64c71abba0e61be1d0389dd8736094f28202f617
{
  temp <- simple_Xmat(overall_lag, econ_features, target_name)
  Y <- temp$Y; Xmat <- temp$Xmat
...
=======
  model.horseshoe <- econ_emotion(3, econ_detrended_names, target_values[cat])
>>>>>>> 64c71abba0e61be1d0389dd8736094f28202f617
}
```
...
```{r}
econ_nrc_rjags <- function(overall_lag, econ_features, target_name) 
>>>>>>> 64c71abba0e61be1d0389dd8736094f28202f617
{
...
=======
models <- econ_nrc_rjags(6, econ_detrended_names, target_values[5])
>>>>>>> 64c71abba0e61be1d0389dd8736094f28202f617
```
